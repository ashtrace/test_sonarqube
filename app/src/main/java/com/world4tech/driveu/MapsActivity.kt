...
import com.world4tech.driveu.databinding.ActivityMapsBinding
import com.world4tech.driveu.parameters.MapData
import com.world4tech.driveu.util.CustomInfoWindowAdapter
import com.world4tech.driveu.util.GetNearbyPlacesData
import com.world4tech.driveu.util.decodePolyline
import com.world4tech.driveu.util.playmusic
...
//    -------------------------
    ...
    roadname = arrayOf(" Suraj Kund Badkhal Rd"," Naraina Ring Road"," Ring Rd"," NH 48"," NH 1"," Outer Ring Road "," Gurugram-Faridabad Road"," Agra expressway"," Mathura Road")
    roadspeed = arrayOf("50","60","60","70","80","90","70","100","60")
    getAreaName(lat,lon)
        //---------------------------------------------------------------------------------
        val handler = Handler()
...
//            fetchnearyByLocation("atm")
    ...
    binding.sos.setOnClickListener {
        ...
        i.putExtra("lon",temporaryLoc!!.latitude.toString())
        startActivity(i)
    }
