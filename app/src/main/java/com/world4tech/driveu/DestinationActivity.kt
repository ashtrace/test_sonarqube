...
import com.world4tech.driveu.adapter.MyAdapter
import com.world4tech.driveu.databinding.ActivityDestinationBinding
import com.world4tech.driveu.util.OnSwipeTouchListener
        ...
        autocompleteSupportFragment1.setOnPlaceSelectedListener(object : PlaceSelectionListener {
            override fun onPlaceSelected(place: Place) {
                ...
                try{
                    ...
                    println("Error happened at destination pge: ${e.message}")
                }
            }
